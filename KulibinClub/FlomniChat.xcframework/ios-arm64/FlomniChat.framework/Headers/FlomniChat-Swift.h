...
#ifndef FLOMNICHAT_SWIFT_H
#define FLOMNICHAT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlomniChat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10FlomniChat11AudioPlayer")
...
SWIFT_CLASS("_TtC10FlomniChat6Camera")
...
@interface Camera (SWIFT_EXTENSION(FlomniChat)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)_ didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

@class NSEntityDescription;
@class NSManagedObjectContext;

SWIFT_CLASS_NAMED("ChatMessageEntity")
@interface ChatMessageEntity : NSManagedObject
...
@interface ChatMessageEntity (SWIFT_EXTENSION(FlomniChat))
- (void)addSeessionObject:(SessionEntity * _Nonnull)value;
- (void)removeSeessionObject:(SessionEntity * _Nonnull)value;
- (void)addSeession:(NSSet * _Nonnull)values;
- (void)removeSeession:(NSSet * _Nonnull)values;
@end
...
@interface ChatMessageEntity (SWIFT_EXTENSION(FlomniChat))
@property (nonatomic, copy) NSData * _Nullable attachments;
@property (nonatomic, copy) NSData * _Nullable buttons;
@property (nonatomic, copy) NSDate * _Nullable changedStatusAt;
@property (nonatomic, copy) NSDate * _Nullable date;
@property (nonatomic, copy) NSData * _Nullable event;
@property (nonatomic, copy) NSString * _Nullable mid;
@property (nonatomic, copy) NSString * _Nullable status;
@property (nonatomic, copy) NSString * _Nullable text;
@property (nonatomic, copy) NSString * _Nullable type;
@property (nonatomic, strong) NSSet * _Nullable seession;
@end



SWIFT_CLASS("_TtC10FlomniChat18FlomniNotification")
@interface FlomniNotification : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface FlomniNotification (SWIFT_EXTENSION(FlomniChat)) <NSFetchRequestResult>
@end


@interface FlomniNotification (SWIFT_EXTENSION(FlomniChat))
@property (nonatomic, readonly) NSUInteger hash;
@end


SWIFT_CLASS("_TtC10FlomniChat24FlomniNotificationEntity")
@interface FlomniNotificationEntity : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface FlomniNotificationEntity (SWIFT_EXTENSION(FlomniChat))
@property (nonatomic, copy) NSData * _Nullable aps;
@property (nonatomic, copy) NSData * _Nullable flomni;
...
SWIFT_CLASS("_TtC10FlomniChat19FoundationTransport")
...
@interface NSData (SWIFT_EXTENSION(FlomniChat)) <NSItemProviderReading>
...
SWIFT_CLASS("_TtC10FlomniChat12NativeEngine") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(watchos,introduced=6.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(macos,introduced=10.15)
...
/// A class that handles notifications and conforms to delegate protocols.
SWIFT_CLASS("_TtC10FlomniChat20NotificationsHandler")
@interface NotificationsHandler : NSObject <UNUserNotificationCenterDelegate>
/// Initializes the <code>NotificationsHandler</code> and sets the delegate for <code>UNUserNotificationCenter</code>.
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
///   </li>
///   <li>
///     response: The <code>UNNotificationResponse</code> received.
///   </li>
/// </ul>
...
///
/// \endcode
SWIFT_CLASS("_TtC10FlomniChat13OnAckCallback")
...
SWIFT_CLASS_NAMED("SessionEntity")
...
@interface SessionEntity (SWIFT_EXTENSION(FlomniChat))
@property (nonatomic, copy) NSString * _Nullable header;
@property (nonatomic, copy) NSString * _Nullable icon;
@property (nonatomic, copy) NSDate * _Nullable lastMessageTimestamp;
@property (nonatomic, copy) NSData * _Nullable message;
@property (nonatomic, copy) NSString * _Nullable sessionId;
@property (nonatomic, copy) NSString * _Nullable subheader;
@property (nonatomic, copy) NSString * _Nullable threadId;
@property (nonatomic, strong) ChatMessageEntity * _Nullable messages;
@end
...
SWIFT_CLASS("_TtC10FlomniChat16SocketAckEmitter")
...
SWIFT_CLASS("_TtC10FlomniChat14SocketAnyEvent")
...
SWIFT_CLASS("_TtC10FlomniChat12SocketEngine")
...
SWIFT_PROTOCOL("_TtP10FlomniChat18SocketEngineClient_")
...
SWIFT_CLASS("_TtC10FlomniChat14SocketIOClient")
...
SWIFT_CLASS("_TtC10FlomniChat13SocketManager")
...
///
/// \endcode
SWIFT_CLASS("_TtC10FlomniChat16SocketRawAckView")
...
///
/// \endcode
SWIFT_CLASS("_TtC10FlomniChat13SocketRawView")
...
@interface UINavigationController (SWIFT_EXTENSION(FlomniChat))
/// Remove back button text for all instances of UINavigationController
